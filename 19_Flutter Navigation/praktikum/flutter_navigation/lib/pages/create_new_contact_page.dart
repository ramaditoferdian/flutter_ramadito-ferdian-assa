...
class _CreateNewContactPageState extends State<CreateNewContactPage> {
  ...
  String? valueSelectedDropdownItem;
  ...
  List<String> valueSelectedCheckbox = [];
  ...
  Widget dropDownSelectJurusan() {
    return Container(
      ...
      child: DropdownButton(
        ...
        isExpanded: true,
        value: valueSelectedDropdownItem,
        items: listDropdown.map(buildMenuItem).toList(),
        onChanged: (String? value) {
          setState(() {
            valueSelectedDropdownItem = value;
          });
        },
      ),
    );
            ...
            onChanged: (value) {
              setState(() {
                ...
                if (data[index]['value'] == true) {
                  valueSelectedCheckbox.add(data[index]['id'].toString());
                } else {
                  valueSelectedCheckbox.remove(data[index]['id'].toString());
                }

                print(valueSelectedCheckbox);
              });
            },
          );
        },
            ...
            () {
              listOfContact.add(
                Contact(
                  ...
                  jurusan: valueSelectedDropdownItem,
                  hobi: valueSelectedCheckbox,
                ),
              );
            },
          );
